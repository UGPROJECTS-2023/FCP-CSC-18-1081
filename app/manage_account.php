                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            ...
                            <span class="input-group-text"><i class="material-icons" aria-hidden="true"></i></span>
                        ...
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            ...
                            <button type="button" tabindex="-1" class="btn btn-outline-primary btn-lg mb-0 rounded-0 border-0 px-1 pass_view"><i class="material-icons"></i></button>
                        </div>
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
