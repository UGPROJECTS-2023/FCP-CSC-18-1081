                ...
                <form action="" id="medicine-form" class="py-3">
                    ...
                    <div id="filter-holder">
                        <div class="input-group mb-3 input-group-dynamic <?= isset($name) ? 'is-filled' : '' ?>">
                            <label for="name" class="form-label">Medication Name <span class="text-primary">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn bg-primary bg-gradient btn-sm text-light w-25"><span class="material-icons"></span> Save</button>
                            <a href="./?page=medicines" class="btn bg-deafult border bg-gradient btn-sm w-25"><span class="material-icons"></span> Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
...
<a href="javascript:void(0)" class="list-group-item list-group-item"></div>
    <div class="d-flex w-100 align-items-center">
        ...
        <div class="col-11">
            <div class="lh-1">
                <h4 class="fw-bolder uname mb-0">Kabir Kabir Dalha</h4>
                <small class="username">Kebee</small>
            </div>
        </div>
    </div>
</a>
