        ...
        <div class="row">
            <div class="col-md-6 position-relative bg-gradient bg-info bg-opacity-25 border-end border-dark">
                <div class="p-3 text-center">
                    ...
                    <p class="text-lg h2 font-weight-normal text-light"><span style="font-size:3rem" class="material-icons"></span></p>
                </div>
            </div>
...
<section class="py-1">
    <div class="container">
        <h1 class="text-center fw-bolder">Welcome to BICHI-VDMTA</h1>
        <hr>
        <div class="row">
